...
class Holding(HoldingBase):
    ...
    sector = models.ForeignKey(Category, related_name='sector', null=True)
    sub_sector = models.ForeignKey(Category, related_name='sub_sector', null=True)
    location = models.ForeignKey(Category, related_name='location', null=True)
    investment_type = models.ForeignKey(Category, related_name='investment_type', null=True)
    asset_class = models.ForeignKey(Category, related_name='asset_class', null=True)
