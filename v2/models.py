...
class Fund(models.Model):
    ...
    region1 = models.ForeignKey(Region, related_name='fund_region1', db_column='Region1ID', blank=True, null=True)
    region2 = models.ForeignKey(Region, related_name='fund_region2', db_column='Region2ID', blank=True, null=True)
    region3 = models.ForeignKey(Region, related_name='fund_region3', db_column='Region3ID', blank=True, null=True)
